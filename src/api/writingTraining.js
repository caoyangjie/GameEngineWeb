...
// 后端调用 DeepSeek 生成题目并保存
// data: { moduleKey, moduleTitle, difficulty, count, templates?: Array<{label,text}> }
export function generateWritingQuestions(data) {
  return request({
    url: '/writing-training/questions/generate',
    method: 'post',
    data
  })
}
...
export function getWritingRecordsByQuestion(params) {
  // params: { questionId }
  return request({
    url: '/writing-training/records/by-question',
    method: 'get',
    params
  })
}
