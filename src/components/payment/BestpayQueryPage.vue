  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.bestpay.query.title') }}</div>
...
import { getPaymentConfigList, bestpayQuery } from '../../api/payment.js'
...
const handleSubmit = async () => {
  try {
    const response = await bestpayQuery({
