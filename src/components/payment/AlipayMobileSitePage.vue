  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.alipay.mobileSite.title') }}</div>
...
import { getPaymentConfigList, alipayMobileSite } from '../../api/payment.js'
...
const handleSubmit = async () => {
  try {
    const response = await alipayMobileSite({
    ...
    if (response.code === 200 && response.data) {
      if (response.data.html) {
        ...
        result.value = {
          success: true,
          message: t('payment.common.operationSuccess'),
          data: response.data
        }
      }
    } else {
