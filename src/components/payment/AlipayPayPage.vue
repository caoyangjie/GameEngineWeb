  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.alipay.pay.title') }}</div>
        ...
        <form @submit.prevent="handleSubmit" class="payment-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label">{{ t('payment.alipay.pay.authCode') }} <span class="required">*</span></label>
              <CustomInput
...
import { getPaymentConfigList, alipayPay } from '../../api/payment.js'
