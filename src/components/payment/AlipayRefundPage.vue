  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.alipay.refund.title') }}</div>
        ...
        <form @submit.prevent="handleSubmit" class="payment-form">
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label">{{ t('payment.common.outTradeNo') }}</label>
              <CustomInput
          ...
          <div class="form-row">
            <div class="form-group">
              <label class="form-label">{{ t('payment.common.transactionId') }}</label>
              <CustomInput
            ...
            <div class="form-group">
              <label class="form-label">{{ t('payment.alipay.refund.refundAmount') }} <span class="required">*</span></label>
              <CustomNumberInput
          ...
          <div class="form-group full-width">
            <label class="form-label">{{ t('payment.alipay.refund.refundReason') }}</label>
            <CustomInput
...
import { getPaymentConfigList, alipayRefund } from '../../api/payment.js'
...
onMounted(() => {
  formData.refundReason = t('payment.alipay.refund.refundReasonPlaceholder')
  loadConfigs()
})
...
const handleSubmit = async () => {
  try {
    const response = await alipayRefund({
