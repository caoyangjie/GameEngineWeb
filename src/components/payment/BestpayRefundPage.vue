  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.bestpay.refund.title') }}</div>
        ...
        <form @submit.prevent="handleSubmit" class="payment-form">
          ...
          <div class="form-group full-width">
            <label class="form-label">{{ t('payment.bestpay.refund.refundAmount') }} <span class="required">*</span></label>
            <CustomNumberInput
...
import { getPaymentConfigList, bestpayRefund } from '../../api/payment.js'
...
const handleSubmit = async () => {
  try {
    const response = await bestpayRefund({
