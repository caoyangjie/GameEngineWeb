  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.wechat.microPay.title') }}</div>
        ...
        <form @submit.prevent="handleSubmit" class="payment-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label">{{ t('payment.wechat.microPay.authCode') }} <span class="required">*</span></label>
              <CustomInput
                v-model="formData.authCode"
                :placeholder="t('payment.common.authCodePlaceholderWechat')"
                required
              />
            </div>
          </div>
          ...
          <button type="submit" class="submit-button">
            <span>{{ t('payment.common.submit') }}</span>
          </button>
...
import { getPaymentConfigList, wechatMicroPay } from '../../api/payment.js'
...
const handleSubmit = async () => {
  try {
    const response = await wechatMicroPay({
