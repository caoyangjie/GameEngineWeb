  ...
  <div class="payment-container">
    ...
    <main class="payment-main-content">
      <div class="payment-panel">
        <div class="payment-title">{{ t('payment.bestpay.barcode.title') }}</div>
        ...
        <form @submit.prevent="handleSubmit" class="payment-form">
          ...
          <div class="form-row">
            <div class="form-group">
              <label class="form-label">{{ t('payment.bestpay.barcode.barcode') }} <span class="required">*</span></label>
              <CustomInput
            ...
            <div class="form-group">
              <label class="form-label">{{ t('payment.bestpay.barcode.goodsName') }} <span class="required">*</span></label>
              <CustomInput
                v-model="formData.goodsName"
                :placeholder="t('payment.bestpay.barcode.goodsNamePlaceholder')"
                required
              />
            </div>
          </div>
...
import { getPaymentConfigList, bestpayBarcode } from '../../api/payment.js'
...
onMounted(() => {
  ...
  formData.goodsName = t('payment.bestpay.barcode.goodsNamePlaceholder')
  loadConfigs()
})

const loadConfigs = async () => {
  try {
    const response = await getPaymentConfigList('BESTPAY')
...
const handleSubmit = async () => {
  try {
    const response = await bestpayBarcode({
