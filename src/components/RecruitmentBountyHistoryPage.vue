<template>
	<div class="recruitment-bounty-history-container">
	  <!-- 背景层 -->
	  ...
	  <!-- 主要内容区域 -->
	  <main class="recruitment-bounty-history-main-content">
		<!-- 标题 -->
		  ...
		  <div class="table-content">
			...
			<div v-else class="table-rows">
			  ...
			  >
				...
				<div class="table-cell">{{ bounty.player }}</div>
				<div class="table-cell">{{ formatAmount(bounty.playerPoolValue) }}</div>
				<div class="table-cell">{{ formatAmount(bounty.myPoolValue) }}</div>
				<div class="table-cell">{{ formatPercentage(bounty.percentage) }}</div>
				<div class="table-cell">{{ formatAmount(bounty.amount) }}</div>
				<div class="table-cell">{{ formatAmount(bounty.usdValue) }}</div>
				<div class="table-cell">{{ formatAmount(bounty.vtPrice) }}</div>
			  </div>
			</div>
		  </div>
		</div>
	  ...
	  <Sidebar 
		:is-open="sidebarOpen" 
		active-route="recruitment-bounty-history"
  ...
  // 招聘赏金数据（示例数据，实际应该从API获取）
  const bounties = ref([
	{
	  id: 1,
	  date: '2025-12-11 00:00:20',
	  player: 'Player001',
	  playerPoolValue: '50000.000',
	  myPoolValue: '45000.000',
	  percentage: '0.150',
	  amount: '11.144',
	  usdValue: '7577.886',
	  vtPrice: '0.850'
	},
	{
	  ...
	  player: 'Player002',
	  playerPoolValue: '51000.000',
	  myPoolValue: '46000.000',
	  percentage: '0.150',
	  amount: '11.161',
	  usdValue: '7589.270',
	  vtPrice: '0.852'
	},
	{
	  ...
	  player: 'Player003',
	  playerPoolValue: '52000.000',
	  myPoolValue: '47000.000',
	  percentage: '0.150',
	  amount: '11.177',
	  usdValue: '7600.671',
	  vtPrice: '0.854'
	},
	{
	  ...
	  player: 'Player004',
	  playerPoolValue: '53000.000',
	  myPoolValue: '48000.000',
	  percentage: '0.150',
	  amount: '11.193',
	  usdValue: '7612.089',
	  vtPrice: '0.856'
	},
	{
	  ...
	  player: 'Player005',
	  playerPoolValue: '54000.000',
	  myPoolValue: '49000.000',
	  percentage: '0.150',
	  amount: '11.209',
	  usdValue: '7623.524',
	  vtPrice: '0.858'
	},
	{
	  ...
	  player: 'Player006',
	  playerPoolValue: '55000.000',
	  myPoolValue: '50000.000',
	  percentage: '0.150',
	  amount: '11.225',
	  usdValue: '7634.976',
	  vtPrice: '0.860'
	},
	{
	  ...
	  player: 'Player007',
	  playerPoolValue: '56000.000',
	  myPoolValue: '51000.000',
	  percentage: '0.150',
	  amount: '11.241',
	  usdValue: '7646.445',
	  vtPrice: '0.862'
	},
	{
	  ...
	  player: 'Player008',
	  playerPoolValue: '57000.000',
	  myPoolValue: '52000.000',
	  percentage: '0.150',
	  amount: '11.257',
	  usdValue: '7657.931',
	  vtPrice: '0.864'
	},
	{
	  ...
	  player: 'Player009',
	  playerPoolValue: '58000.000',
	  myPoolValue: '53000.000',
	  percentage: '0.150',
	  amount: '11.273',
	  usdValue: '7669.434',
	  vtPrice: '0.866'
	},
	{
	  ...
	  player: 'Player010',
	  playerPoolValue: '59000.000',
	  myPoolValue: '54000.000',
	  percentage: '0.150',
	  amount: '11.289',
	  usdValue: '7680.954',
	  vtPrice: '0.868'
	},
	{
	  ...
	  player: 'Player011',
	  playerPoolValue: '60000.000',
	  myPoolValue: '55000.000',
	  percentage: '0.150',
	  amount: '11.305',
	  usdValue: '7692.491',
	  vtPrice: '0.870'
  ...
  <style scoped>
  .recruitment-bounty-history-container {
	position: relative;
	width: 100%;
	height: 100vh;
	overflow-y: auto;
  ...
  /* 主要内容区域 */
  .recruitment-bounty-history-main-content {
	position: relative;
	z-index: 5;
	padding: 40px;
	max-width: 1400px;
  ...
  .table-header {
	display: grid;
	grid-template-columns: 1.2fr 1fr 1.2fr 1.2fr 0.9fr 1fr 1.2fr 1fr;
	gap: 10px;
	padding: 20px;
  ...
  @media (max-width: 1200px) {
	...
	.table-header,
	.table-row {
	  grid-template-columns: 1fr 0.9fr 1fr 1fr 0.8fr 0.9fr 1fr 0.9fr;
	  font-size: 11px;
	}
