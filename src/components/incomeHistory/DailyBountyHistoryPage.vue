<template>
	<div class="daily-bounty-history-container">
	  <!-- 背景层 -->
	  ...
	  <!-- 主要内容区域 -->
	  <main class="daily-bounty-history-main-content">
		<!-- 标题 -->
		<div class="title-section">
		  <div class="title-banner">
			<span class="title-icon">💰</span>
			<span class="title-text">{{ t('dailyBountyHistory.title') }}</span>
		  </div>
		</div>
		...
		<div class="filter-section">
		  <div class="filter-row">
			<div class="filter-field">
			  <label class="filter-label">{{ t('dailyBountyHistory.startDate') }}</label>
			  <CustomDatePicker
				v-model="filters.startDate"
			  />
			</div>
			<div class="filter-field">
			  <label class="filter-label">{{ t('dailyBountyHistory.endDate') }}</label>
			  <CustomDatePicker
		  ...
		  <button class="filter-button" @click="applyFilter">
			{{ t('dailyBountyHistory.applyFilter') }}
		  </button>
		</div>
		...
		<div class="history-table-section">
		  ...
		  <div class="table-header">
			<div class="header-cell">{{ t('dailyBountyHistory.date') }}</div>
			<div class="header-cell">{{ t('dailyBountyHistory.amount') }}</div>
			<div class="header-cell">{{ t('dailyBountyHistory.percentage') }}</div>
			<div class="header-cell">{{ t('dailyBountyHistory.purchaseValue') }}</div>
		  </div>
	  ...
	  <Sidebar 
		:is-open="sidebarOpen" 
		active-route="daily-bounty-history"
  ...
  <style scoped>
  .daily-bounty-history-container {
	position: relative;
	width: 100%;
	height: 100vh;
	overflow-y: auto;
  ...
  /* 主要内容区域 */
  .daily-bounty-history-main-content {
	position: relative;
	z-index: 5;
	padding: 40px;
	max-width: 1400px;
