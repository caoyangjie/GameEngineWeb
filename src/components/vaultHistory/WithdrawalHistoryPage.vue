<template>
		  ...
		  <div class="filter-row">
			...
			<div class="filter-field">
			  ...
			  <CustomSelect
				...
				:placeholder="t('withdrawalHistory.all')"
			  />
			</div>
			<div class="filter-field">
  ...
  const statusOptions = computed(() => [
	{ value: '', label: t('withdrawalHistory.all') },
	{ value: 'pending', label: t('withdrawalHistory.pending') },
	{ value: 'processed', label: t('withdrawalHistory.processed') },
	{ value: 'failed', label: t('withdrawalHistory.failed') }
  ])
